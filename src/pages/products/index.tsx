...
import { getPriceDisplay, ProductCategory, productData, ProductDetail, productNavigate } from '@Data/products';
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const pageSize = 10;
  const category = validateWithFallbackValue(query.category, oneOf(['cables', 'earphones']), '');
